                    ...
                    <div class="col text-center">
                        <div class="card visimisi-card mt-5">
                            <div class="card-body ">
                                ...
                                <p class="text-center text-dark fw-bold fs-4 mb-5">“Terselenggaranya jaringan Komunikasi dan Informatika yang terintegrasi untuk mendukung terwujudnya Pemerintahan yang baik.”</p>
                                <h2 class="text-center text-primary fw-bold mb-4">Misi</h2>
                                <ul class="text-start text-dark fw-bold fs-5 mb-4 " style="margin-left: 3rem ; margin-right: 3rem">
                                    <li> Mewujudkan Jaringan Komunikasi dan Informatika yang terintegrasi </li>
                                    <li> Mewujudkan Sarana Komunikasi dan Diseminasi Informasi yang Efektif </li>
                                    <li> Melaksanakan Pengelolaan Data dan Produksi Secara Elektronik </li>
                                    <li> Melaksanakan Urusan Rumah Tangga untuk Mendukung Peningkatan Kapasitas Organisasi dan Pengembangan Sumber Daya Manusia. </li>
                                </ul>
                            </div>
                        </div>
                    </div>
