...
<div class="container">
    <div class="card rounded-3 shadow-sm" >
        <div class="card-body mx-4 my-2">
            <form action="/foto" method="POST" enctype="multipart/form-data" style="margin-bottom: 2rem">
                <h2 class="font-weight-bold">Atur Foto Instansi</h2>
                @csrf
                    ...
                    @foreach ($fotos as $foto)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/foto/edit/{{ $foto->id }}" class="btn btn-warning mb-3" >Edit</a>
